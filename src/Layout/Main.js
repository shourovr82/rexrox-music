  ...
  return (
    <div className=''>
      ...
      <div className='grid lg:grid-cols-5 grid-cols-3'>
        ...
        <div className='col-span-1  h-[100vh] bg-white shadow-2xl'>
          {/* left sidebar */}
          <div class="px-4 py-6">
            <span class="block py-2 bg-gray-400 rounded-lg">REXROX</span>
            ...
            <nav aria-label="Main Nav" class="flex flex-col mt-6 space-y-1">
              ...
              <details class="group [&_summary::-webkit-details-marker]:hidden">
                ...
                >
                  ...
                  <span class="ml-3 text-sm font-medium"> Browse </span>
              ...
              >
                ...
                <span class="ml-3 text-sm font-medium"> Album </span>
              </a>
              ...
              >
                ...
                <span class="ml-3 text-sm font-medium"> Artists </span>
              </a>
