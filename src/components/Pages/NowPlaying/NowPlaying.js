...
import { GiMusicalNotes, GiNextButton, GiPreviousButton } from 'react-icons/gi';
...
const NowPlaying = () => {
  ...
  return (
    ...
    <div>
      <div className='mb-3'>
        <h2 className='flex items-center gap-3 '> <span className='text-xl font-bold'>Now Playing</span> <GiMusicalNotes /> </h2>
      </div>
